        ...
        <div class="row">
            <div id="main-content" class="col-lg-9 col-lg-push-3">
                ...
                <ul class="nav nav-tabs nav-justified">
                    <li role="presentation" id="active-orders" class="active"><a href="/waiter">Активні замовлення</a></li>
                    <li role="presentation" id="all-orders"><a href="/waiter/orders">Усі замовлення</a></li>
                </ul>
                <div id="mycontext">
